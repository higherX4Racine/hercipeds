...
COHORT_STATS <- tibble::tribble(
    ~ GRTYPE, ~ Years, ~ `Award Sought`, ~ Statistic,
         ...
         18L,      4L, "Certificate",    "Revised cohort",
         ...
         27L,      2L, "Any degree",     "Revised cohort",
